...
static const char* SHADER_PATH = "shaders/quantum_coherence.comp.spv";

bool quantum_coherence_create(vk_context* ctx, quantum_coherence_renderer* renderer, u32 width, u32 height) {
    memset(renderer, 0, sizeof(quantum_coherence_renderer));
    ...
    push.ranges[0] = (VkPushConstantRange){
        ...
        .offset = 0,
        .size = sizeof(quantum_coherence_params),
    };
    push.range_count = 1;
...
void quantum_coherence_render(vk_context* ctx, quantum_coherence_renderer* renderer, VkCommandBuffer cmd, u32 frame_index) {
    vk_cmd_begin_label(ctx, cmd, "Quantum Coherence", (float[4]){0.6f, 0.2f, 0.8f, 1.0f});
